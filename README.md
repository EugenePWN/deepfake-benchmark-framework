...
Автоматизированный фреймворк для генерации датасетов дипфейков с контролируемой сложностью и тестирования детекторов.
...
- **Честная оценка** — identity-aware split, один датасет как targets и real одновременно (устранение dataset bias), поддержка любых источников изображений
